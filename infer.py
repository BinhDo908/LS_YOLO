...
# Image dataset root (override with LS_IMAGES env var)
IMG_ROOT = os.environ.get("LS_IMAGES", "datasets/images")

# Default test image (change this to any .tif you want)
DEFAULT_IMAGE = os.path.join(IMG_ROOT, "palu", "img", "Palu0513.tif")

# One representative image per source type for quick cross-dataset testing
SAMPLE_IMAGES = [
    (os.path.join(IMG_ROOT, "Jiuzhai valley (UAV-0.2m)", "img", "jiuzzhaigou_0.2m_UVA0500.tif"),  "UAV 0.2m"),
    (os.path.join(IMG_ROOT, "Jiuzhai valley (UAV-0.5m)", "img", "jiuzzhaigou_0.5m_UVA0500.tif"),  "UAV 0.5m"),
    (os.path.join(IMG_ROOT, "Longxi River（UAV）", "img", "longxihe_UAV0500.tif"),                  "UAV Longxi"),
    (os.path.join(IMG_ROOT, "Moxi town（UAV-0.2m）", "img", "moxizheng_0.2m_UAV0500.tif"),         "UAV Moxi 0.2m"),
    (os.path.join(IMG_ROOT, "Moxitaidi (UAV-0.6m)", "img", "luding_UAV0500.tif"),                  "UAV Moxi 0.6m"),
    (os.path.join(IMG_ROOT, "Longxi River(SAT)", "img", "LongxiheSAT0500.tif"),                    "SAT Longxi"),
    (os.path.join(IMG_ROOT, "Tiburon Peninsula（Sentinel）", "img", "Haiti002.tif"),                "SAT Sentinel"),
    (os.path.join(IMG_ROOT, "Tiburon Peninsula（planet）", "img", "Haiti_Planet001.tif"),           "SAT Planet"),
    (os.path.join(IMG_ROOT, "palu", "img", "Palu0513.tif"),                                        "SAT Palu"),
    (os.path.join(IMG_ROOT, "Moxi town（UAV-0.2m）", "img", "moxizheng_0.2m_UAV0430.tif"),         "UAV Moxi 0.2m"),
    (os.path.join(IMG_ROOT, "Hokkaido Iburi-Tobu", "img", "Hokkaido1136.tif"), "UAV Hokkaido"),
    (os.path.join(IMG_ROOT, "Hokkaido Iburi-Tobu", "img", "Hokkaido1138.tif"), "SAT Hokkaido"),
]
